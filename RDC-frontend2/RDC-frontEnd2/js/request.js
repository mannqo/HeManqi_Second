...
let thumbUpAndDown = function (res, dianZan) {
...
let dislikeOrNot = function (res, cai) {
    // 点踩按钮
        ...
        axios.get(url + 'article/getArticle', {
            ...
            .then(function (response) {
                ...
                for (let i = 0; i < res.length; i++) {
                 ...
                 <li>
                 <p>`+ res[i].author + `</p>
                 <h3 data-index="`+ i + `">` + res[i].title + `</h3>
            ...
            .then((res) => {
                ...
                for (let i = 0; i < hVisited.length; i++) {
                    hVisited[i].onclick = function () {
                        ...
                        axios.get(url + 'article/getArticle', {
                            ...
                            .then(response => {
                                let res1 = response.data.data;
                                getArticleDetail(res1[j]);
                                // console.log(res1);
                                getArticleComment(res1[j])
                            })
                ...
                dislikeOrNot(result, myCai);
                // 我不够聪明以至于这个方法1我想了一天5555----数组合并(就能保存下来前面几页的数据啦！！)
                thumbUpAndDown(result, myZan);
